...
public class Directions {
    public static String[] dirReduc(String[] arr) {
        ...
        for (int i = 0; i < directions.size()-1;) {
            ...
            ArrayList<String> nextTwoDirections = new ArrayList<>();
            nextTwoDirections.add(directions.get(i));
            nextTwoDirections.add(directions.get(i+1));
            if(nextTwoDirections.contains("NORTH") && nextTwoDirections.contains("SOUTH")){
                eliminate = true;
            }else if(nextTwoDirections.contains("WEST") && nextTwoDirections.contains("EAST")){
                eliminate = true;
            }
            if(eliminate){
                directions.remove(i);
